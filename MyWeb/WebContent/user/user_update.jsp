			...
			<div class="col-md-offset-2 col-md-4">
				<div class="panel" style="width: 200%;">
					<div class="panel-heading text-white" align="center"
						...
						<h2>
							<span style="color: gray;">MyWeb</span> 회원 수정
						</h2>
					</div>
						...
						<form action="user_update_con.jsp" method="post"
							...
							<table
								...
								<tr>
									<td style="text-align: left">
										<p>
											<strong>이름을 수정해주세요.</strong>&nbsp;&nbsp;&nbsp;
										</p>
									</td>
								</tr>
								<tr>
									<td><input type="text" name="name"
										value="<%=vo.getName()%>" class="form-control" maxlength="6"
								...
								<tr>
									<td style="text-align: left">
										<p>
											<strong>이메일을 수정해주세요.</strong>&nbsp;&nbsp;&nbsp;
										</p>
									</td>
								</tr>
								<tr>
									<td><input type="email" name="email"
										value="<%=vo.getEmail()%>" class="form-control"
										style="margin-bottom: 25px; width: 100%; height: 40px; border: 1px solid #d9d9de"></td>
								</tr>
								<tr>
									<td style="text-align: left">
										<p>
											<strong>주소를 수정해주세요.</strong>&nbsp;&nbsp;&nbsp;
										</p>
									</td>
								</tr>
								<tr>
									<td><input type="text" name="address"
										value="<%=vo.getAddress()%>" class="form-control"
										style="margin-bottom: 25px; width: 100%; height: 40px; border: 1px solid #d9d9de"></td>
								</tr>
								<tr>
									<td style="width: 100%; text-align: center; colspan: 2;">
										<input type="submit" value="정보 수정"
										class="btn btn-primary btn-lg" onclick="confirm('수정하시겠습니까?')">&nbsp;&nbsp;
										<input type="button" value="취소" class="btn btn-danger btn-lg"
										onclick="location.href='user_mypage'"> &nbsp;&nbsp;
